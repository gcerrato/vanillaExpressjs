...
import { assertIsStackPlan } from './assertions/assertStackPlan.js';
import { loadingSpinner, prettyPrintStackModificationPlan } from './prompts.js';
import { validateUniqueStackName, validateUniqueApplicationName, prettyPrintDeployResults, getGitBranch, getRemoteUrl, ensureHttpPrefix, hasApplicationErrors, getApplicationWithGithubAppError, } from './utils.js';
...
export class RestackCloud {
    ...
    stack(_a) {
        return __awaiter(this, arguments, void 0, function* ({ name, previewEnabled = false, applications = [], }) {
            ...
            const gitUrl = yield getRemoteUrl();
            ...
            const response = yield fetch(`${this.url}/sdk/plan`, {
                ...
                body: JSON.stringify({
                    name,
                    previewEnabled,
                    applications: applications.map((app) => (Object.assign(Object.assign(Object.assign({}, app), { gitUrl, gitBranch: branch, dockerFilePath: app.dockerFilePath.replace(/^\.\//, '') }), (app.dockerBuildContext && {
